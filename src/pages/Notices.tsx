...
const Notices = () => {
  ...
  const [expandedNotices, setExpandedNotices] = useState<Set<number>>(
    new Set()
  );
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-16">
              <div className="flex items-center gap-4 mb-4">
                ...
                <span className="font-mono text-xs text-secondary tracking-[0.3em]">
                  UPDATES
                </span>
              </div>
                    ...
                    <div
                      ...
                      <div className="p-6">
                        ...
                        <div className="relative mb-4">
                          ...
                          {((notice.rich_description &&
                            notice.rich_description.replace(/<[^>]*>/g, "")
                              .length > 150) ||
                            notice.description.length > 120) && (
                            <button
                              onClick={(e) =>
                                toggleNoticeExpansion(notice.id, e)
                              }
