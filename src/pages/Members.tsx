                ...
                {faculty.map((facultyMember, index) => (
                  <div
                    ...
                    className={`group relative overflow-hidden ${
                      faculty.length === 1
                        ? "grid md:grid-cols-[300px,1fr] gap-6 items-center bg-card border border-border hover:border-primary/50 transition-all duration-500"
                        : ""
                    }`}>
                    {faculty.length === 1 ? (
                      <>
                        ...
                        <div className="relative md:block p-6 md:p-0">
                          <div className="relative w-full aspect-square md:w-full">
                            ...
                            <div className="absolute inset-3 sm:inset-4 overflow-hidden bg-muted">
                              <img
                                src={
                                  facultyMember.image || "/default-avatar.png"
                                }
                        ...
                        <div className="p-6 space-y-3">
                          ...
                          {(facultyMember.linkedin ||
                            ...
                            <div className="flex items-center gap-2 pt-2">
                              {facultyMember.linkedin && (
                                <a
                                  href={normalizeUrl(facultyMember.linkedin)}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="w-8 h-8 border border-border hover:border-primary hover:bg-primary/5 flex items-center justify-center transition-all"
                                  title="LinkedIn">
                              ...
                              {facultyMember.github && (
                                <a
                                  href={normalizeUrl(facultyMember.github)}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="w-8 h-8 border border-border hover:border-primary hover:bg-primary/5 flex items-center justify-center transition-all"
                                  title="GitHub">
                              ...
                              {facultyMember.instagram && (
                                <a
                                  href={normalizeUrl(facultyMember.instagram)}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="w-8 h-8 border border-border hover:border-primary hover:bg-primary/5 flex items-center justify-center transition-all"
                                  title="Instagram">
                        ...
                        <div className="bg-card border border-border hover:border-primary/50 transition-all duration-500 flex flex-col h-full">
                          ...
                          <div className="p-5 space-y-2 text-center flex-1 flex flex-col">
                            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-primary/10 border border-primary/30 mx-auto">
                              ...
                              <span className="text-[10px] font-mono text-primary tracking-wide uppercase">
                                {facultyMember.title}
                              </span>
                            </div>
                            <h3 className="text-lg font-black text-foreground leading-tight pt-1">
                              {facultyMember.name}
                            </h3>
                              ...
                              <div className="flex items-center gap-2 pt-2 justify-center">
                                {facultyMember.linkedin && (
                                  <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-7 h-7 border border-border hover:border-primary hover:bg-primary/5 flex items-center justify-center transition-all"
                                    title="LinkedIn">
