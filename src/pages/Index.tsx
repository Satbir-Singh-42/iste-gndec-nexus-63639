...
const Index = () => {
  ...
  return (
    <>
      <Helmet>
        <title>ISTE GNDEC Student Chapter | Technical Education & Innovation Hub</title>
        <meta name="description" content="Official ISTE Student Chapter at Guru Nanak Dev Engineering College, Ludhiana. Join us for technical workshops, hackathons, seminars, competitions, and innovation programs. Empowering engineering students." />
