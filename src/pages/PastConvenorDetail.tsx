      ...
      <main className="pt-16 pb-8 px-4 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <div className="bg-card border border-primary/20 rounded-lg p-3">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  {convenor.linkedin && (
                    <a
                      href={
                        convenor.linkedin.startsWith("http")
                          ? convenor.linkedin
                          : `https://linkedin.com/in/${convenor.linkedin}`
                      }
                      target="_blank"
                  ...
                  {convenor.github && (
                    <a
                      href={
                        convenor.github.startsWith("http")
                          ? convenor.github
                          : `https://github.com/${convenor.github}`
                      }
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 px-2.5 py-1.5 bg-primary/10 hover:bg-primary/20 border border-primary/30 rounded-lg transition-colors text-sm">
                  ...
                  {convenor.instagram && (
                    <a
                      href={
                        convenor.instagram.startsWith("http")
                          ? convenor.instagram
                          : `https://instagram.com/${convenor.instagram}`
                      }
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 px-2.5 py-1.5 bg-primary/10 hover:bg-primary/20 border border-primary/30 rounded-lg transition-colors text-sm">
          ...
          <div className="md:col-span-2">
            <div className="rounded-lg border border-primary/20 bg-muted/30 p-4 sm:p-6">
              <div className="w-full aspect-[3/4] max-w-md mx-auto flex items-center justify-center bg-background/50 rounded overflow-hidden">
                <img
                  src={convenor.image}
                  alt={convenor.name}
